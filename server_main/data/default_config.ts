...
// changed items
export let currentItems = initCurrentItems();

export function resetCurrentItems() {
    currentItems = initCurrentItems(); 
}

function initCurrentItems() {
   let items = new Map<string, IPendulumElem>();
    // copy values
    defaultItemsConfig.forEach((item) => {
